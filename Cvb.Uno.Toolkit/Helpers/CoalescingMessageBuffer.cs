...
public sealed class CoalescingMessageBuffer<TKey, TValue>(IEqualityComparer<TKey>? comparer = null) where TKey : notnull
{
	private readonly Lock _sync = new();
	private readonly Dictionary<TKey, TValue> _pending = new(comparer);
