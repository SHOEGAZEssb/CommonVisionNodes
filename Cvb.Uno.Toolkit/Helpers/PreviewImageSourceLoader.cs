...
public static class PreviewImageSourceLoader
{
	...
	{
		var state = LoadStates.GetValue(image, static _ => new ImageLoadState());
	...
	private static WriteableBitmap CreateRawBitmap(ImageLoadState state, ImagePreviewDto preview, byte[] bytes)
	{
