...
public partial class MinosSearchNodeViewModel : NodeViewModel
{
		...
		: base(node, definition)
	{
		...
		_searchOperation = GetString("SearchOperation", FirstOptionOrDefault(_availableSearchOperations, "FindAll"));
	...
	public string SearchOperation
	{
		...
		set => SetOptionValue(ref _searchOperation, value, nameof(SearchOperation));
	}
